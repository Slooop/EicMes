...
namespace MES.ModuleBPM
{
    ...
    /// FlowCard.xaml 的交互逻辑
    /// </summary>
    public partial class ProcessTemprateSet : UserControl
    {
        public ProcessTemprateSet()
        {
           
            InitializeComponent();
            ProcessTemprateSetViewModel vm = new ProcessTemprateSetViewModel();
            this.DataContext = vm;
        ...
        {
            cmb_PtNameList.ItemsSource= Business.BpmHelper.ProductTemplate.GetPTName("制六部", ((ComboBox)sender).SelectedValue.ToString());
        }
    }
