...
namespace MES.Server.DBUtility
{
    ...
    public class DbHelperSQLP
    {
        ...
        public DbHelperSQLP(PubConnection conn)
        {
            switch (conn)
            {
                case PubConnection.mes:
                    connectionString = PubConstant.ConnectionString;
                    break;
                case PubConnection.lig:
                    connectionString = PubConstant.ConnectionStringlig;
                    break;
                case PubConnection.TwoLine:
                    connectionString = PubConstant.ConnectionStringTwoLine;
                    break;
                default:
                    break;
            }
