...
{
	/// <summary>
	/// OQC_ProductPrintConfig
	/// </summary>
	public partial class OQC_ProductPrintConfig
	{
		private readonly IOQC_ProductPrintConfig dal=DataAccess.CreateOQC_ProductPrintConfig();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MES.Server.Model.OQC_ProductPrintConfig GetModelByCache(string ProductID)
		{
			
			string CacheKey = "OQC_ProductPrintConfigModel-" + ProductID;
			...
			return (MES.Server.Model.OQC_ProductPrintConfig)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MES.Server.Model.OQC_ProductPrintConfig> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MES.Server.Model.OQC_ProductPrintConfig> DataTableToList(DataTable dt)
		{
			List<MES.Server.Model.OQC_ProductPrintConfig> modelList = new List<MES.Server.Model.OQC_ProductPrintConfig>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MES.Server.Model.OQC_ProductPrintConfig model;
