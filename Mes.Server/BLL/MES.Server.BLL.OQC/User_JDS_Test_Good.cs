...
namespace MES.Server.BLL
{
	...
	{
		private readonly IUser_JDS_Test_Good dal=DataAccess.CreateUser_JDS_Test_Good();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MES.Server.Model.User_JDS_Test_Good GetModelByCache(decimal ID_Key)
		{
			...
			return (MES.Server.Model.User_JDS_Test_Good)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MES.Server.Model.User_JDS_Test_Good> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MES.Server.Model.User_JDS_Test_Good> DataTableToList(DataTable dt)
		{
			List<MES.Server.Model.User_JDS_Test_Good> modelList = new List<MES.Server.Model.User_JDS_Test_Good>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MES.Server.Model.User_JDS_Test_Good model;
