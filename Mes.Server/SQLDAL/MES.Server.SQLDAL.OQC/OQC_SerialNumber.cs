...
{
	/// <summary>
	/// 数据访问类:OQC_SerialNumber
	/// </summary>
	public partial class OQC_SerialNumber:IOQC_SerialNumber
	{
		...
		public bool Exists(string SN)
		{
			...
			strSql.Append("select count(1) from OQC_SerialNumber");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into OQC_SerialNumber(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update OQC_SerialNumber set ");
		...
		public bool Delete(string SN)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from OQC_SerialNumber ");
			strSql.Append(" where SN=@SN ");
			SqlParameter[] parameters = {
					new SqlParameter("@SN", SqlDbType.VarChar,50)			};
			parameters[0].Value = SN;
		...
		public MES.Server.Model.OQC_SerialNumber GetModel(string SN)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SN,Type,State,Qty,BatchNo,OrderID,R1 from OQC_SerialNumber ");
			strSql.Append(" where SN=@SN ");
			SqlParameter[] parameters = {
					new SqlParameter("@SN", SqlDbType.VarChar,50)			};
			parameters[0].Value = SN;

			MES.Server.Model.OQC_SerialNumber model=new MES.Server.Model.OQC_SerialNumber();
		...
		/// 得到一个对象实体
		/// </summary>
		public MES.Server.Model.OQC_SerialNumber DataRowToModel(DataRow row)
		{
			MES.Server.Model.OQC_SerialNumber model=new MES.Server.Model.OQC_SerialNumber();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM OQC_SerialNumber ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from OQC_SerialNumber T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "OQC_SerialNumber";
